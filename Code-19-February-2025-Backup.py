...
class Programs(object):
    ...
    async def Run6(self) -> None:
        ...
        await runloop.sleep_ms(250)
        await driveBase.gyroForwards(25, 450, 700, kp = 175, ki = 1, kd = 0, constantsScale = 1000)
        ...
        await runloop.sleep_ms(250)
        await driveBase.turnRight(895, 350, 500, kLeft = 1, kRight = 0, error = 75)
        await runloop.sleep_ms(250)

        await driveBase.gyroForwards(108, 800, 800, kp = 175, ki = 1, kd = 0, constantsScale = 1000)
        await driveBase.gyroBackwards(70, 800, 900, kp = 175, ki = 1, kd = 0, constantsScale = 1000)

        await driveBase.turnRight(700, 275, 275, kLeft = 0, kRight = -1, error = 75)
