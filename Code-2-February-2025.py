...
class Programs(object):
    ...
    async def Run1(self) -> None:
        ...
        # await driveBase.turnLeft(17, 500, 500, kLeft = 0, kRight = 1, error = 0)
        await driveBase.gyroForwards(280, 750, 1000, kp = 325, ki = 20, kd = 125, constantsScale = 1000)

        await runloop.sleep_ms(1000)

        await motor.run_for_degrees(driveBase.rightMotorSYS, -1250, 1000) # Move Arm
    ...
    async def Run5(self) -> None:
        ...
        await runloop.sleep_ms(250)
        await driveBase.gyroBackwards(818, 250, 700, kp = 1000, ki = 80, kd = 300, constantsScale = 1000)
        await runloop.sleep_ms(250)
    ...
    async def Run6(self) -> None:
        ...
        await runloop.sleep_ms(250)
        await driveBase.gyroBackwards(132, 300, 600, kp = 175, ki = 1, kd = 0, constantsScale = 1000)
        await runloop.sleep_ms(250)
        await driveBase.turnRight(530, 100, 100, kLeft = 1, kRight = 0)
        await runloop.sleep_ms(250)
        ...
        await runloop.sleep_ms(250)
        await driveBase.turnLeft(653, 200, 300, kLeft = -1, kRight = 1, error = 100)
        await runloop.sleep_ms(250)
    ...
    async def Run7(self) -> None:
        ...
        # Start
        await driveBase.gyroForwards(760, 350, 1000, kp = 125, ki = 6, kd = 35, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInCubic)
        await runloop.sleep_ms(250)
        await driveBase.turnRight(450, 200, 200, kLeft = 1, kRight = 0, error = 75)
        await runloop.sleep_ms(500)
        await driveBase.gyroForwards(105, 250, 300, kp = 100, ki = 5, kd = 25, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInCubic)
        await runloop.sleep_ms(250)
        await motor.run_for_degrees(driveBase.rightMotorSYS, -125, 200)
        await runloop.sleep_ms(750)
        motor.run_for_degrees(driveBase.rightMotorSYS, 150, 600)

        await driveBase.gyroBackwards(250, 250, 600, kp = 100, ki = 5, kd = 25, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInCubic)
        await runloop.sleep_ms(250)
        await driveBase.turnLeft(370, 200, 300, kLeft = 0, kRight = 1)
        await runloop.sleep_ms(500)
        await motor.run_for_degrees(driveBase.leftMotorSYS, 212, 750)
        await runloop.sleep_ms(250)
        await driveBase.gyroForwards(140, 250, 800, kp = 100, ki = 1, kd = 25, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInCubic)
        await runloop.sleep_ms(500)
    ...
    async def Run8(self) -> None:
        ...
        await runloop.sleep_ms(250)
        await driveBase.gyroForwards(175, 500, 800, kp = 0, ki = 0, kd = 0)
        await runloop.sleep_ms(250)
