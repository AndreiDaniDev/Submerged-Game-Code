...
class Programs(object):
    ...
    async def Run1(self) -> None:
        ...
        await driveBase.gyroForwards(274, 675, 1000, kp = 325, ki = 20, kd = 125, constantsScale = 1000)
        ...
        await driveBase.gyroForwards(88, 200, 200, kp = 325, ki = 20, kd = 250, constantsScale = 1000)

        await runloop.sleep_ms(250)

        runloop.run(
            motor.run_for_degrees(driveBase.leftMotorSYS, -1250 , 1000), # Attach corals
            motor.run_for_degrees(driveBase.rightMotorSYS, 1000, 1000) # Get Little Guy
        )
        ...
        runloop.run(
            ...
            motor.run_for_degrees(driveBase.rightMotorSYS, -750, 1000) # Retrive Little Guy
        )

        runloop.run(
            driveBase.gyroBackwards(400, 1000, 500, kp = 325, ki = 20, kd = 250, constantsScale = 1000, easingMethod = SpeedMethods.easeOutQuad), # Return
            motor.run_for_degrees(driveBase.rightMotorSYS, 1100, 750)
        )
    ...
    async def Run3(self) -> None:
        ...
        await driveBase.turnRight(150, 200, 200, kLeft = 1, kRight = 0, error = 75)
        await runloop.sleep_ms(250)

        await driveBase.gyroForwards(555, 500, 1000, kp = 175, ki = 12, kd = 75, constantsScale = 1000)
        await runloop.sleep_ms(250)
        await driveBase.turnRight(730, 300, 300, kLeft = 0, kRight = -1, error = 75)
        await runloop.sleep_ms(250)

        await driveBase.gyroForwards(275, 450, 1000, kp = 225, ki = 12, kd = 75, constantsScale = 1000)
        await runloop.sleep_ms(1000)

        # Return to base
        await driveBase.gyroBackwards(180, 250, 750, kp = 175, ki = 12, kd = 25, constantsScale = 1000, easingMethod = SpeedMethods.easeInQuad)
        await runloop.sleep_ms(250)

        await driveBase.turnRight(1100, 350, 350, kLeft = 1, kRight = -1, error = 200)
        await runloop.sleep_ms(250)
    ...
    async def Run4(self) -> None:
        ...
        # ---> Go to mission <---
        await driveBase.gyroForwards(605, 750, 1000, kp = 175, ki = 10, kd = 30, constantsScale = 1000)
        await runloop.sleep_ms(500)
        await driveBase.turnLeft(550, 175, 175, kLeft = -1, kRight = 1, error = 75)
        await runloop.sleep_ms(500)
        await driveBase.gyroForwards(214, 500, 600, kp = 175, ki = 7, kd = 25, constantsScale = 1000)
        await runloop.sleep_ms(500)
        await driveBase.gyroBackwards(14, 200, 200, kp = 175, ki = 7, kd = 25, constantsScale = 1000)
        await runloop.sleep_ms(500)

        # ---> Collect trident <---
        await motor.run_for_degrees(driveBase.leftMotorSYS, -1600, 1000)
        await driveBase.gyroForwards(95, 100, 250, kp = 175, ki = 7, kd = 25, constantsScale = 1000)
    ...
    async def Run5(self) -> None:
        ...
        await runloop.sleep_ms(250)
        await driveBase.gyroBackwards(818, 250, 699, kp = 925, ki = 125, kd = 375, constantsScale = 1000)
        await runloop.sleep_ms(250)
        await driveBase.turnRight(1000, 1000, 1000, kLeft = 1, kRight = -1, error = 200)

        await driveBase.gyroForwards(210, 800, 1000, kp = 175, ki = 10, kd = 30, constantsScale = 1000)
        await runloop.sleep_ms(250)
        ...
        #await driveBase.gyroBackwards(600, 750, 1000, kp = 800, ki = 50, kd = 150, constantsScale = 1000)

        return None

    async def Run6(self) -> None:
        await driveBase.initRun()
        await driveBase.gyroForwards(580, 550, 1000, kp = 175, ki = 1, kd = 0, constantsScale = 1000)
        await runloop.sleep_ms(250)
        await driveBase.gyroBackwards(137, 300, 600, kp = 175, ki = 1, kd = 0, constantsScale = 1000)
        await runloop.sleep_ms(250)
        await driveBase.turnRight(530, 150, 150, kLeft = 1, kRight = 0)
        await runloop.sleep_ms(250)
        await driveBase.gyroForwards(28, 450, 700, kp = 175, ki = 1, kd = 0, constantsScale = 1000)

        await motor.run_for_degrees(driveBase.rightMotorSYS, -1700, 1000)
        await runloop.sleep_ms(250)
        await driveBase.turnRight(430, 250, 250, kLeft = 1, kRight = -1, error = 75)
        await runloop.sleep_ms(250)

        await runloop.sleep_ms(250)
        await driveBase.turnLeft(215, 250, 250, kLeft = -1, kRight = 1, error = 75)
        await runloop.sleep_ms(250)

        await driveBase.gyroBackwards(147, 400, 600, kp = 100, ki = 1, kd = 0, constantsScale = 1000)
        motor.run_for_degrees(driveBase.rightMotorSYS, 1700, 1000)
        await runloop.sleep_ms(250)
        await driveBase.turnLeft(670, 200, 300, kLeft = -1, kRight = 1, error = 75)
        await runloop.sleep_ms(250)
        await driveBase.gyroForwards(230, 250, 700, kp = 175, ki = 1, kd = 0, constantsScale = 1000)
        await runloop.sleep_ms(250)
        await driveBase.turnRight(902, 350, 500, kLeft = 1, kRight = 0, error = 75)
        await runloop.sleep_ms(250)

        await driveBase.gyroForwards(108, 800, 800, kp = 175, ki = 1, kd = 0, constantsScale = 1000)
        await driveBase.gyroBackwards(40, 800, 900, kp = 175, ki = 1, kd = 0, constantsScale = 1000)

        await driveBase.turnRight(875, 275, 275, kLeft = 0, kRight = -1, error = 75)
        await driveBase.gyroForwards(1000, 1000, 1000, kp = 175, ki = 1, kd = 0, constantsScale = 1000)
    ...
    async def Run7(self) -> None:
        ...
        # Start
        await driveBase.gyroForwards(760, 350, 1000, kp = 150, ki = 12, kd = 75, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInCubic)
        await runloop.sleep_ms(250)
        await driveBase.turnRight(450, 200, 200, kLeft = 1, kRight = 0, error = 75)
        await runloop.sleep_ms(500)
        await driveBase.gyroForwards(96, 250, 300, kp = 100, ki = 5, kd = 25, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInCubic)
        await runloop.sleep_ms(250)
        await motor.run_for_degrees(driveBase.rightMotorSYS, -425, 600)
        await runloop.sleep_ms(450)
        #motor.run_for_degrees(driveBase.rightMotorSYS, 150, 600)

        await driveBase.gyroBackwards(320, 250, 600, kp = 150, ki = 12, kd = 75, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInCubic)
        await runloop.sleep_ms(250)
        await driveBase.turnLeft(360, 200, 300, kLeft = 0, kRight = 1)
        await runloop.sleep_ms(500)
        await motor.run_for_degrees(driveBase.leftMotorSYS, 200, 750)
        await runloop.sleep_ms(250)
        await driveBase.gyroForwards(145, 250, 800, kp = 150, ki = 12, kd = 75, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInCubic)
        await runloop.sleep_ms(500)
        await motor.run_for_degrees(driveBase.leftMotorSYS, -80, 750)
        await driveBase.gyroBackwards(87, 250, 1000, kp = 150, ki = 12, kd = 75, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInCubic)

        await driveBase.turnLeft(250, 250, 250, kLeft = -1, kRight = 1)
        await driveBase.gyroBackwards(725, 250, 1000, kp = 100, ki = 5, kd = 25, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInCubic)
    ...
    async def Run8(self) -> None:
        ...
        await driveBase.turnLeft(280, 200, 200, kLeft = 0, kRight = 1)
        await driveBase.gyroForwards(240, 700, 1000, kp = 175, ki = 1, kd = 25)
        await runloop.sleep_ms(500)
        await driveBase.gyroBackwards(170, 500, 700, kp = 0, ki = 0, kd = 0)
        await runloop.sleep_ms(250)
        await driveBase.gyroForwards(190, 500, 800, kp = 0, ki = 0, kd = 0)
        await runloop.sleep_ms(250)
        await driveBase.gyroBackwards(100, 500, 700, kp = 0, ki = 0, kd = 0)
        await runloop.sleep_ms(250)
    ...
    async def Run9(self) -> None:
        ...
        await driveBase.gyroForwards(505, 400, 1000, kp = 150, ki = 10, kd = 25, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInQuad)
        await runloop.sleep_ms(250)
        await driveBase.turnRight(485, 200, 200, kLeft = 1, kRight = -1, error = 75)
        await runloop.sleep_ms(250)
        await driveBase.gyroForwards(520, 750, 1000, kp = 160, ki = 10, kd = 25, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInQuad)
        await runloop.sleep_ms(250)
        await motor.run_for_degrees(driveBase.rightMotorSYS, 900, 1000)
        await runloop.sleep_ms(500)
        await motor.run_for_degrees(driveBase.rightMotorSYS, -150, 1000)
        '''
        await driveBase.gyroForwards(80, 750, 1000, kp = 160, ki = 10, kd = 25, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInQuad)
        await runloop.sleep_ms(500)
        await driveBase.turnRight(300, 200, 200, kLeft = 1, kRight = -1, error = 75)
        await runloop.sleep_ms(250)
