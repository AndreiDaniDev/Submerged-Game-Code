...
class Programs(object):
    ...
    async def Run5(self) -> None:
        ...
        await driveBase.gyroForwards(1420, 500, 700, kp = 150, ki = 2, kd = 0, constantsScale = 1000)
        await runloop.sleep_ms(1000)
        await driveBase.turnRight(372, 200, 300, kLeft = 1, kRight = 0)
        await runloop.sleep_ms(500)
        await driveBase.gyroForwards(255, 200,300, kp = 150, ki = 2, kd = 0, constantsScale = 1000)
        await runloop.sleep_ms(500)
        await motor.run_for_degrees(driveBase.leftMotorSYS, -275, 200)
        await runloop.sleep_ms(500)
        motor.run_for_degrees(driveBase.leftMotorSYS, 275, 200)

        await driveBase.gyroBackwards(625, 200, 300, kp = 150, ki = 2, kd = 0, constantsScale = 1000)
        await runloop.sleep_ms(500)
