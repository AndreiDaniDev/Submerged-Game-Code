...
class Programs(object):
    ...
    async def Run7(self) -> None:
        ...
        await runloop.sleep_ms(500)
        await driveBase.gyroBackwards(825, 200, 800, kp = 150, ki = 2, kd = 0, constantsScale = 1000, stallDetectionThreshold = 5, stallDetectionIterator = 500)
        await runloop.sleep_ms(500)

        # After octopus
        await driveBase.gyroForwards(190, 200, 400, kp = 175, ki = 2, kd = 0, constantsScale = 1000)
        await runloop.sleep_ms(500)
        await driveBase.turnLeft(950, 200, 300, kLeft = -1, kRight = 1, error = 75) #
        await runloop.sleep_ms(500)
        await driveBase.gyroForwards(475, 250, 500, kp = 175, ki = 2, kd = 0, constantsScale = 1000)
        await runloop.sleep_ms(250)

        await motor.run_for_degrees(driveBase.rightMotorSYS, -1000, 1250)
        await runloop.sleep_ms(500)
        await driveBase.turnRight(400, 250, 250, kLeft = 1, kRight = -1, error = 75) #
        await runloop.sleep_ms(500)
        
        # Hope - After boat
        await driveBase.turnLeft(250, 200, 200, kLeft = -1, kRight = 1)
        await runloop.sleep_ms(250)
        await driveBase.gyroBackwards(175, 200, 300, kp = 175, ki = 2, kd = 0, constantsScale = 1000)
        await runloop.sleep_ms(500)
        await driveBase.gyroForwards(350, 200, 400, kp = 175, ki = 2, kd = 0, constantsScale = 1000)
        await runloop.sleep_ms(500)
        
        # Hope - After Collecting
        await driveBase.turnLeft(900, 200, 200, kLeft = -1, kRight = 1, error = 50)
