...
class Programs(object):
    ...
    async def Run2(self) -> None:
        ...
        await driveBase.gyroForwards(1250, 250, 1000, kp = 200, ki = 20, kd = 25, constantsScale = 1000)
        await driveBase.turnRight(900, 200, 300, kLeft = 0, kRight = -1, error = 75)
    ...
    async def Run4(self) -> None:
        ...
        # ---> Go to mission <---
        await driveBase.gyroForwards(1185, 500, 1000, kp = 175, ki = 7, kd = 25, constantsScale = 1000)
        await runloop.sleep_ms(500)
        await driveBase.turnLeft(510, 125, 125, kLeft = -1, kRight = 1, error = 75)
        await runloop.sleep_ms(500)
        await driveBase.gyroForwards(428, 500, 600, kp = 175, ki = 7, kd = 25, constantsScale = 1000)
        await runloop.sleep_ms(500)
        await driveBase.gyroBackwards(24, 200, 200, kp = 175, ki = 7, kd = 25, constantsScale = 1000)
        await runloop.sleep_ms(500)

        # ---> Collect trident <---
        await motor.run_for_degrees(driveBase.leftMotorSYS, -1500, 1000)
        await driveBase.gyroForwards(180, 100, 250, kp = 175, ki = 7, kd = 25, constantsScale = 1000)

        motor.run_for_degrees(driveBase.leftMotorSYS, 1400, 1000)
        await driveBase.gyroBackwards(200, 200, 200, kp = 175, ki = 7, kd = 25, constantsScale = 1000)
        await runloop.sleep_ms(500)
        await driveBase.turnRight(200, 200, 200, kLeft = 1, kRight = -1, error = 75)
        await runloop.sleep_ms(500)
        await driveBase.gyroBackwards(1600, 1000, 1000, kp = 175, ki = 7, kd = 25, constantsScale = 1000)
...
async def main() -> None:
    ...
    # await programManager.PlayProgram(4)
    return None
