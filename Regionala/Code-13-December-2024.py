...
class Programs(object):
    ...
    async def Run3(self) -> None:
        ...
        await driveBase.gyroForwards(750, 500, 1000, kp = 175, ki = 14, kd = 25, constantsScale = 1000)
        await runloop.sleep_ms(250)
        await driveBase.turnRight(50, 250, 250, kLeft = 1, kRight = -1)
        await runloop.sleep_ms(250)
        await driveBase.gyroForwards(1250, 500, 1000, kp = 175, ki = 14, kd = 25, constantsScale = 1000)
        ...
        await driveBase.gyroBackwards(2000, 500, 1000, kp = 175, ki = 14, kd = 25, constantsScale = 1000)
