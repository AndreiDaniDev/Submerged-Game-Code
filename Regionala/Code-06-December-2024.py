...
class Programs(object):
    ...
    async def Run8(self) -> None:
        ...
        motor.run_for_degrees(driveBase.rightMotorSYS, 275, 250)

        await driveBase.gyroForwards(1400, 250, 1000, kp = 200, ki = 7, kd = 25, constantsScale = 1000, accelerationScale = 500)
        await runloop.sleep_ms(1000)
        await driveBase.turnRight(370, 200, 200, kLeft = 1, kRight = 0)
        await runloop.sleep_ms(500)
        await driveBase.gyroForwards(210, 500, 400, kp = 200, ki = 7, kd = 25, constantsScale = 1000)
        await runloop.sleep_ms(500)
        await motor.run_for_degrees(driveBase.rightMotorSYS, -275, 300)
        await runloop.sleep_ms(500)
        motor.run_for_degrees(driveBase.rightMotorSYS, 250, 100)

        await driveBase.gyroBackwards(630, 250, 350, kp = 200, ki = 7, kd = 25, constantsScale = 1000)
        await runloop.sleep_ms(500)
        ...
        await driveBase.gyroForwards(445, 300, 400, kp = 200, ki = 7, kd = 25, constantsScale = 1000)
        await runloop.sleep_ms(500)
        await motor.run_for_degrees(driveBase.leftMotorSYS, -137, 750)
        await driveBase.gyroBackwards(175, 300, 400, kp = 200, ki = 7, kd = 25, constantsScale = 1000)
        await runloop.sleep_ms(500)

        await driveBase.turnLeft(250, 250, 300, kLeft = -1, kRight = 1)
        await driveBase.gyroBackwards(1750, 1000, 1000, kp = 200, ki = 7, kd = 25, constantsScale = 1000)
