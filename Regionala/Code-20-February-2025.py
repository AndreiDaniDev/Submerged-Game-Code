...
class Programs(object):
    ...
    async def Run1(self) -> None:
        ...
        await driveBase.gyroForwards(285, 675, 1000, kp = 325, ki = 32, kd = 125, constantsScale = 1000)
        ...
        runloop.run(
            driveBase.gyroForwards(72, 300, 300, kp = 325, ki = 20, kd = 250, constantsScale = 1000),
    ...
    async def Run2(self) -> None:
        ...
        await driveBase.turnRight(63, 250, 250, kLeft = 1, kRight = 0)
        motor.run_for_degrees(driveBase.rightMotorSYS, -100, 1000)
        await driveBase.gyroForwards(300, 500, 1000, kp = 175, ki = 17, kd = 37, constantsScale = 1000)

        await runloop.sleep_ms(500)

        await driveBase.turnLeft(82, 250, 250, kLeft = -1, kRight = 0, error = 65)
        await driveBase.gyroForwards(695, 750, 1000, kp = 175, ki = 17, kd = 37, constantsScale = 1000)

        await motor.run_for_degrees(driveBase.rightMotorSYS, -550, 1000)
        await motor.run_for_degrees(driveBase.rightMotorSYS, 750, 1000)

        await driveBase.arcTurnBackwards(1000, driveBase.rightMotorDB, 650, 1000, 1000, error = 75)
    ...
    async def Run3(self) -> None:
        ...
        await driveBase.gyroForwards(270, 625, 1000, kp = 225, ki = 12, kd = 75, constantsScale = 1000)
        await runloop.sleep_ms(1000)

        # Return to base
        await driveBase.gyroBackwards(180, 250, 750, kp = 175, ki = 12, kd = 25, constantsScale = 1000, easingMethod = SpeedMethods.easeOutBack)
        await runloop.sleep_ms(250)
    ...
    async def Run5(self) -> None:
        ...
        await runloop.sleep_ms(250)
        await driveBase.gyroBackwards(818, 250, 450, kp = 920, ki = 285, kd = 380, constantsScale = 1000)
        await runloop.sleep_ms(250)
    ...
    async def Run6(self) -> None:
        await driveBase.initRun()
        await driveBase.gyroForwards(580, 550, 1000, kp = 200, ki = 1, kd = 25, constantsScale = 1000)
        await runloop.sleep_ms(250)
        await driveBase.gyroBackwards(115, 300, 600, kp = 200, ki = 1, kd = 0, constantsScale = 1000)
        await runloop.sleep_ms(250)
        await driveBase.turnRight(525, 150, 150, kLeft = 1, kRight = 0)
        await runloop.sleep_ms(250)
        await driveBase.gyroForwards(28.5, 450, 700, kp = 175, ki = 1, kd = 0, constantsScale = 1000)
        ...
        await driveBase.gyroBackwards(142, 400, 600, kp = 100, ki = 1, kd = 0, constantsScale = 1000)
        await runloop.sleep_ms(250)
        ...
        await runloop.sleep_ms(250)
        await driveBase.turnRight(897, 350, 500, kLeft = 1, kRight = 0, error = 75)
        await runloop.sleep_ms(250)

        await driveBase.gyroForwards(108, 800, 800, kp = 175, ki = 1, kd = 0, constantsScale = 1000)
        await runloop.sleep_ms(500)
        await driveBase.gyroBackwards(25, 800, 900, kp = 175, ki = 1, kd = 0, constantsScale = 1000)

        #await driveBase.arcTurnForwards(1000, driveBase.rightMotorDB, 650, 1000, 1000, error = 75)
        await driveBase.turnRight(680, 275, 275, kLeft = 0, kRight = -1, error = 75)
