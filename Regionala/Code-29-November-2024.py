...
class Programs(object):
    ...
    async def Run1(self) -> None:
        ...
        # Smecherie (care nu merge)
        # await driveBase.gyroForwards(20, 350, 500, kp = 325, ki = 17, kd = 200, constantsScale = 1000)
        # await driveBase.turnLeft(100, 250, 250, kLeft = -1, kRight = 1, error = 50)
        # await driveBase.gyroBackwards(17, 350, 500, kp = 325, ki = 17, kd = 200, constantsScale = 1000)

        await driveBase.turnLeft(25, 400, 400, kLeft = -1, kRight = 1, error = 0) # Bulaneala
        await driveBase.gyroForwards(800, 350, 500, kp = 325, ki = 20, kd = 250, constantsScale = 1000)
        ...
        await motor.run_for_degrees(driveBase.rightMotorSYS, 1100, 1000)
