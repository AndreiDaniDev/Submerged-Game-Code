...
class Programs(object):
    ...
    async def Run1(self) -> None:
        driveBase.initRun()
        # ---> Code <--- + ---> Big system (depercated / backup) <---
    ...
    async def Run8(self) -> None:
        ...
        await driveBase.gyroForwards(1400, 250, 1000, kp = 100, ki = 5, kd = 25, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInCubic)
        await runloop.sleep_ms(500)
        await driveBase.turnRight(400, 250, 250, kLeft = 1, kRight = 0)
        await runloop.sleep_ms(500)
        await driveBase.gyroForwards(300, 250, 1000, kp = 100, ki = 5, kd = 25, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInCubic)
        await runloop.sleep_ms(500)
    ...
    async def Run11(self) -> None:
        ...
        await driveBase.gyroForwards(760, 500, 1000, kp = 175, ki = 8, kd = 25, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInQuad)
        await runloop.sleep_ms(500)
        await driveBase.turnRight(479, 300, 300, kLeft = 0, kRight = -1)
        await runloop.sleep_ms(500)
        await driveBase.gyroForwards(1150, 750, 1000, kp = 175, ki = 8, kd = 25, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInQuad)
        await runloop.sleep_ms(500)
        await motor.run_for_degrees(driveBase.rightMotorSYS, 800, 1000)
        await runloop.sleep_ms(500)
        
        await driveBase.gyroForwards(350, 750, 1000, kp = 175, ki = 8, kd = 25, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInQuad)
        await motor.run_for_degrees(driveBase.rightMotorSYS, 320, 1000)
        await driveBase.turnRight(400, 175, 175, kLeft = 0, kRight = -1)
        await driveBase.gyroForwards(295, 750, 1000, kp = 175, ki = 8, kd = 25, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInQuad)
        
        motor.run_for_degrees(driveBase.rightMotorSYS, -400, 500)
        await motor.run_for_degrees(driveBase.leftMotorSYS, 800, 1000)
        await runloop.sleep_ms(2000)
        await driveBase.gyroBackwards(200, 750, 1000, kp = 175, ki = 8, kd = 25, constantsScale = 1000, easingMethod = SpeedMethods.easeOutInQuad)
