...
class Programs(object):
    ...
    async def Run1(self) -> None:
        ...
        await driveBase.gyroForwards(332, 350, 500, kp = 325, ki = 20, kd = 250, constantsScale = 1000)
        await motor.run_for_degrees(driveBase.rightMotorSYS, 275, 1000) # Collect shark
        await runloop.sleep_ms(1000) # Wait a little bit
        await motor.run_for_degrees(driveBase.rightMotorSYS, -500, 1000)
        await driveBase.gyroForwards(55, 150, 200, kp = 325, ki = 20, kd = 250, constantsScale = 1000)
        await runloop.sleep_ms(500)
        await motor.run_for_degrees(driveBase.leftMotorSYS, -765, 999) # Attach corals
        await runloop.sleep_ms(500)
