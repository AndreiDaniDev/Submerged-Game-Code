...
class Programs(object):
    ...
    async def Run1(self) -> None:
        ...
        await runloop.sleep_ms(500)
        await driveBase.gyroForwards(335, 600, 800, kp = 0.48, ki =  32.194, kd = 0.45)
        await motor.run_for_degrees(driveBase.rightMotorSYS, 450, 700)
        await runloop.sleep_ms(250)
        await motor.run_for_degrees(driveBase.rightMotorSYS, -490, 800)
        await runloop.sleep_ms(250)
        await driveBase.gyroForwards(250, 1000, 1000, kp = 0.48, ki =32.194, kd = 0.45)
        # 0.7528399 0.000566062 0.4000319
        # await driveBase.gyroForwards(500, 500, 500, kp = 0.75, ki = 0.0005, kd = 0.4)
    ...
    async def Run8(self) -> None:
        await driveBase.initRun()
        await driveBase.gyroForwards(640, 500, 700, kp = 0.4556837, ki = 0.01805082, kd = 0.45)
        await motor.run_for_degrees(driveBase.leftMotorSYS, -170, 750)
        await runloop.sleep_ms(250)
        await driveBase.gyroBackwards(700, 1000, 1000, kp = 0.4516163, ki = 0.0004192375, kd = 0.45)
        '''await driveBase.turnLeft(200, 1000, 1000, kLeft = -1, kRight = 0)
        await motor.run_for_degrees(driveBase.leftMotorSYS, -170, 750)
        await driveBase.turnRight(100, 125, 125, kLeft = 1, kRight = 0)'''
