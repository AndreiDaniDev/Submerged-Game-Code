...
class Programs(object):
    ...
    async def Run2(self) -> None:
        ...
        await runloop.sleep_ms(250)
        await driveBase.gyroForwards(300, 500, 1000, kp = 0.6, ki = 0.00005, kd = 0.45)
        await runloop.sleep_ms(250)
        
        # ---> Collect rest of the elements <---
        await driveBase.turnLeft(75, 125, 125, kLeft = 0, kRight = 1, error = 32) # No turn - Only gyro Reset
        await runloop.sleep_ms(250)
        await driveBase.gyroForwards(100, 500, 1000, kp = 0.6, ki = 0.00005, kd = 0.45)
        await runloop.sleep_ms(250)
    ...
    async def Run3(self) -> None:
        ...
        # ---> Code <--- + ---> Align to boat <---
        motor.run_for_degrees(driveBase.leftMotorSYS, -400, 1000)
        ...
        await runloop.sleep_ms(250)
        await driveBase.gyroForwards(267, 250, 1000, kp = 0.6, ki = 0.00005, kd = 0.45)
        await runloop.sleep_ms(250)
        await driveBase.turnRight(620, 225, 225, kLeft = 1, kRight = 0, error = 87)
        await runloop.sleep_ms(250)

        # ---> Retrieve treasure and complete boat <---
        await driveBase.gyroForwards(310, 525, 1000, kp = 0.6, ki = 0.00005, kd = 0.45)
        await runloop.sleep_ms(250)
        await driveBase.gyroBackwards(200, 375, 750, kp = 0.6, ki = 0.00005, kd = 0.45, easingMethod = SpeedMethods.linear)
