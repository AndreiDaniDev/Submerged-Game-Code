...
class Programs(object):
    ...
    async def Run2(self) -> None:
        ...
        await driveBase.turnRight(250, 225, 225, kLeft = 1, kRight = 0, error = 85)
        await runloop.sleep_ms(250)
        await driveBase.gyroForwards(300, 600, 1000, kp = 0.6, ki = 0.00005, kd = 0.45)
        await runloop.sleep_ms(250)

        # ---> Collect rest of the elements <---
        await driveBase.turnLeft(75, 125, 125, kLeft = 0, kRight = 1, error = 32) # No turn - Only gyro Reset
        await runloop.sleep_ms(250)
        await driveBase.gyroForwards(100, 600, 1000, kp = 0.6, ki = 0.00005, kd = 0.45)
        await runloop.sleep_ms(250)
        await driveBase.turnRight(100, 175, 175, kLeft = 0, kRight = -1, error = 50)
        await runloop.sleep_ms(250)
        await driveBase.gyroForwards(200, 1000, 1000, kp = 0.6, ki = 0.00005, kd = 0.45)
        await motor.run_for_degrees(driveBase.leftMotorSYS, 375, 1000)
        await driveBase.gyroBackwards(625, 1000, 1000, kp = 0.6, ki = 0.00005, kd = 0.45)
    ...
    async def Run8(self) -> None:
        await driveBase.initRun()
        await driveBase.gyroForwards(650, 500, 800, kp = 0.4556837, ki = 0.01805082, kd = 0.45)
        await driveBase.turnLeft(100, 1000, 1000, kLeft = -1, kRight = 0)
