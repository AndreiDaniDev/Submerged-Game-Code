...
class Programs(object):
    ...
    async def Run1(self) -> None:
        driveBase.initRun()
        # ---> Code <---
        await driveBase.gyroForwards(765, 600, 669, kp = 160, ki = 0, kd = 0, constantsScale = 100)
        await runloop.sleep_ms(500)
        await motor.run_for_degrees(driveBase.leftMotorSYS, -500, 400)
        motor.run_for_degrees(driveBase.leftMotorSYS, -500, 1000)
        #brat pentru om sa se ridice putin,brat pentru turn la maxim rapid
        #fata
        #brat om lasat in jos rapid brat om sus
        #spate
        return None
